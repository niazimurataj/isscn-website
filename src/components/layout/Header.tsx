      ...
      <nav className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <Link
              href="/contact"
              className="px-5 py-2.5 bg-[#2F3E4E] text-white font-semibold rounded-lg hover:bg-[#3d4f61] transition-colors"
            >
              Get Involved
            </Link>
          </div>
          ...
          <button
            type="button"
            className="lg:hidden p-2 rounded-lg text-[#5B6B7A] hover:text-[#2F3E4E] hover:bg-[#9AA7B2]/10"
